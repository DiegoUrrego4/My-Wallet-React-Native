    ...
    <View style={accountStyles.screenContainer}>
      ...
      <View style={accountStyles.movementsContainer}>
        <ScrollView>
          ...
          />
          <Movement
            imageUrl="https://arepiz.com/wp-content/uploads/2019/12/logo-arepiz.png"
            movementFor={'Compra Arepiz'}
            date={'11:20 AM - 12/09/2022'}
            quantity={'37.500'}
            typeOfMovement={'outcome'}
          />
        </ScrollView>
